...
function SibeBarGroupContent({notes}:{ notes: Note[]}) {
  ...
  return (
    <SidebarGroupContentShadCN>
        <div className="relative flex items-center">
            ...
            <Input className="bg-muted pl-8" placeholder="Search notes..." value={searchText} onChange={(e)=>setSearchText(e.target.value)}/>
        </div>
...
export default SibeBarGroupContent